...
-- PII-free evidence summary for the health dashboard and mutation gate. The ramp
-- worker never receives addresses, message bodies, provider ids, or secrets.
...
as $$
  ...
  from receipt_summary r, processing_summary p, diagnostic_summary d, suppression_summary s;
$$;
