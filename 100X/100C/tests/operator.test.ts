...
const eligible: SyncCandidate = { canonicalContactId: "c1", canonicalProspectId: "p1", workEmail: "dir@biz.example.com", normalizedEmail: "dir@biz.example.com", firstName: "D", lastName: "D", fullName: "D D", title: "Owner", companyName: "Biz", website: "https://biz.example.com", websiteDomain: "biz.example.com", outreachEligibility: "ready_for_outreach", emailVerificationStatus: "verified", suppressionStatus: "none", isCurrentContact: true, provider: "apollo", providerRecordId: "r1", lastVerifiedAt: "2026-08-08T00:00:00Z", eligibleCleaningCompany: true, isCustomer: false };
const compliance = {
