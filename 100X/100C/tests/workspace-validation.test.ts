...
describe("C1 run fails closed on workspace mismatch/absence — no reservation or lead", () => {
  ...
  const cand: SyncCandidate = { canonicalContactId: "c1", canonicalProspectId: "p1", workEmail: "d@biz.example.com", normalizedEmail: "d@biz.example.com", firstName: "D", lastName: "D", fullName: "D D", title: "Owner", companyName: "Biz", website: "https://biz.example.com", websiteDomain: "biz.example.com", outreachEligibility: "ready_for_outreach", emailVerificationStatus: "verified", suppressionStatus: "none", isCurrentContact: true, provider: "apollo", providerRecordId: "r1", lastVerifiedAt: "2026-08-08T00:00:00Z", eligibleCleaningCompany: true, isCustomer: false };
