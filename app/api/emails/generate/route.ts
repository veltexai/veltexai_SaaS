  ...
  try {
    ...
    const getEmailTypeInstructions = (type: string) => {
      const typeInstructions = {
        proposal_send:
          "Create a professional email to accompany a proposal. Focus on introducing the proposal, highlighting key benefits, and encouraging review.",
        follow_up:
          "Create a follow-up email to check on proposal status. Be polite, show continued interest, and offer to answer questions.",
        thank_you:
          "Create a thank you email after proposal acceptance or meeting. Express gratitude and outline next steps.",
        reminder:
          "Create a gentle reminder email about a pending proposal. Be respectful of their time while encouraging action.",
        custom:
          "Create a custom email based on the provided context. Follow the tone and purpose specified.",
      };
      return (
        typeInstructions[type as keyof typeof typeInstructions] ||
        typeInstructions.proposal_send
      );
    };
