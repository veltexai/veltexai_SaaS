...
export function CatalogDocument({ content, companyName, showPoweredBy = true }: { content: string; companyName?: string; showPoweredBy?: boolean }) {
  return <article className="catalog-document mx-auto max-w-3xl bg-white p-5 text-gray-900 sm:p-10" data-extras-ready="true">
    ...
    {showPoweredBy && <footer className="mt-8 border-t pt-3 text-xs text-gray-500">Prepared with Veltex AI · Suggested pricing requires operator review</footer>}
  </article>;
}
